...
public class TabFg2 extends Fragment {

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        final View view = inflater.inflate(R.layout.fg2_tab, container, false);
    ...
    View.OnLongClickListener listenClick = new View.OnLongClickListener()
    {
        ...
        public boolean onLongClick(View v)
        {
            ...
            TabFg2.DragShadow dragShadow = new TabFg2.DragShadow(v);//Shadow generated once long pressed.
