...
public class TabFg3 extends Fragment {

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        final View view = inflater.inflate(R.layout.fg3_tab, container, false);
    ...
    View.OnLongClickListener listenClick = new View.OnLongClickListener()
    {
        ...
        public boolean onLongClick(View v)
        {
            ...
            TabFg3.DragShadow dragShadow = new TabFg3.DragShadow(v);//Shadow generated once long pressed.
